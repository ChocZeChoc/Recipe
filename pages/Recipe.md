		...
		- [[Hainan-style chicken/Khoa mun kai]] ^^Missing^^ **Missing**
			...
			- [[Nathan's style spicy garlic chili oil pasta]] (I have not measure the exact amout for this yet this is just an estimate)
				...
				- [[Ingredient]]
					...
					- 15ml oil (1 Tbsp)
					- 100g Sausage (Can be substitute with up to 250g of meat)
					- [[Optional]]
						- msg
				- [[Instruction]]
					...
					- Add the sausages(or meat) into the pan and cook until all the meat is brown. You could also do this step first for easier control on the meats. (I usually cook the meat in oil by it)
	- [[Dessert]]
	  collapsed:: true
		- [[Fruit Lather]]
			- 10 [[Servings]]
